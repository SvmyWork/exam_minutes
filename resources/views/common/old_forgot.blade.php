...
<form class="space-y-3" method='POST' action='{{ route("common.emailverify") }}'>
  @csrf
    <div>
      ...
      <input type="email" id="email" placeholder="eg., name@company.com"
             class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" name='email'/>
    </div>
