...
@section('content-form')
    ...
    <form class="space-y-3" method="POST" action="{{ route('common.store') }}">
      ...
      <div>
        ...
        <input type="text" id="name" placeholder="e.g., John Smith" name = "name" required
      ...
      <div>
        ...
        <input type="email" id="email" placeholder="e.g., name@company.com" name="email" required
               class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"/>
      </div>
      ...
      <div>
        ...
        <input type="password" id="confirm_password" placeholder="••••••••" name="password" required
               class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"/>
