...
<head>
    ...
    <title>{{$title}}</title>
    <link rel="icon" type="image/png" href="{{ asset('assets/images/XcceedAI_logo.png') }}">
...
<body class="bg-[#f5f7fe] bg-overlay flex flex-col items-center justify-center font-sans px-4 mt-12">
