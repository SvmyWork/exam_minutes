...
<body class="font-sans bg-white m-0 overflow-hidden h-screen h-[50px]">
    ...
    <div class="flex h-[calc(100%-3.5rem)]"> <!-- Header is ~3.5rem -->
        <div class="flex-1 flex flex-col">
            ...
            <!-- Fixed footer -->
            <footer class="bg-white border-t p-4 text-right">
                <button onclick="window.location.href = '{{ route('exam.instructions-2') }}';"
                    class="px-4 py-2 border border-gray-400 bg-gray-100 hover:bg-gray-200">
            Next &gt;
            </button>
