...
<head>
    ...
    <style>
        /* Ensure footer remains visible on mobile by limiting instructions height */
...
<body class="font-sans bg-white m-0 overflow-hidden h-screen flex flex-col">
    ...
    <div class="flex flex-1 min-h-0"> <!-- Take full remaining height after header -->
        <div class="flex flex-col flex-1"> <!-- Main content area minus header height -->
            ...
            <footer id="page-footer"
                class="bg-white border-t p-4 shrink-0 items-center justify-between shadow-sm min-h-[200px] sm:min-h-[50px]">
                <div class="sm:flex-row sm:items-center flex-auto min-w-0">
                    <div class="flex items-center mb-2 sm:mb-0 sm:mr-6">
                        <label for="lang" class="mr-2">Choose Language: </label>
                        <select name="lang" id="lang" class="border border-gray-400 bg-gray-100 px-2 py-1">
                    ...
                    <div class="flex-1 flex items-center">
                        <div class="ack-box flex-1 mb-2 sm:mb-0" style="max-height: 100px; overflow-y: auto;">
                            ...
                            prohibited gadget like mobile phone, bluetooth devices etc. /any prohibited material with me
                            into
                            the Examination Hall. I agree that in case of not adhering to the instructions, I shall be
                            liable to
                            be debarred from this Test and/or to disciplinary action, which may include ban from future
                            Tests /
                            Examinations
                        </div>
                    </div>
                </div>
                <div class="flex justify-between ml-4 mr-4 sm:mt-5">
                    <button id="prev-btn" class="px-4 py-2 border border-gray-400 bg-gray-100 hover:bg-gray-200" onclick="window.location.href='{{ route('exam.instructions') }}'">
                        &lt; Previous
                    </button>
                    <button id="startBtn" disabled class="px-4 py-2 border border-gray-400 bg-gray-300 hover:bg-gray-200 cursor-not-allowed" onclick="window.location.href='{{ route('exam.paper', ['paperid' => 5]) }}'">
                        Start &gt;
                    </button>
                </div>   
        ...
        <aside class="w-64 bg-gray-100 border-l p-4 text-center h-full hidden sm:block">
            <img src="https://img.freepik.com/free-vector/smiling-young-man-illustration_1308-173524.jpg?w=740"
