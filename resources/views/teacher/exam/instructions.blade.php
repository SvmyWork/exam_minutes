...
<body class="font-sans bg-white m-0 overflow-hidden h-screen flex flex-col">
    ...
    <div class="flex flex-1 min-h-0"> <!-- Take full remaining height after header -->
        <div class="flex flex-col flex-1"> <!-- Main content area minus header height -->
            ...
            <!-- Fixed footer -->
            <footer id="page-footer" class="bg-white border-t p-4 text-right shrink-0 h-16 flex items-center justify-end shadow-sm">
                <button class="px-4 py-2 border border-gray-400 bg-gray-100 hover:bg-gray-200" onclick="window.location.href = '{{ route('exam.instructions-2') }}';">Next &gt;</button>
            </footer>
        </div>
